...
namespace Common.Battle
{
    public class AttributeData
    {
        ...
        public float MaxHP
        {
            get
            {
                return Data[(int)AttributeType.MaxHP];
            }
        ...
        public float MaxMP
        {
            get
            {
                return Data[(int)AttributeType.MaxMP];
            }
        ...
        public float STR
        {
            get
            {
                return Data[(int)AttributeType.STR];
            }
        ...
        public float INT
        {
            get
            {
                return Data[(int)AttributeType.INT];
            }
        ...
        public float DEX
        {
            get
            {
                return Data[(int)AttributeType.DEX];
            }
        ...
        public float AD
        {
            get
            {
                return Data[(int)AttributeType.AD];
            }
        ...
        public float AP
        {
            get
            {
                return Data[(int)AttributeType.AP];
            }
        ...
        public float DEF
        {
            get
            {
                return Data[(int)AttributeType.DEF];
            }
        ...
        public float MDEF
        {
            get
            {
                return Data[(int)AttributeType.MDEF];
            }
        ...
        public float SPD
        {
            get
            {
                return Data[(int)AttributeType.SPD];
            }
        ...
        public float CRI
        {
            get
            {
                return Data[(int)AttributeType.CRI];
            }
